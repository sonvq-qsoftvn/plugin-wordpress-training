<?php
global $font_face, $font_size_list, $font_style_list, $font_unit_list, $font_transform_list, $web_fonts_array, $google_subset;
...
$font_unit_list = array(
	'px' => 'px',
	'em' => 'em'
);

$font_transform_list = array(
	''           => 'No transform',
	'uppercase'  => 'Uppercase',
	'lowercase'  => 'Lowercase',
